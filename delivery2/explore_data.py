...
entropy_fig, entropy_axes = plt.subplots()
entropy_exp.plot(ax=entropy_axes)
entropy_axes.set_title('Entropy of Expression Distrubution')
entropy_axes.set_xlabel('gene #')
entropy_axes.set_ylabel('entropy. exp.')
plt.show()